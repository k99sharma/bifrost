...
async function fetchCountryData(name){
    // api url
    const API_url = 'https://ghost-32-bifrost.herokuapp.com/bifrost/v1.0/country?name=';
...
function handleModal(data) {
    ...
    const currencySymbolHolder = document.querySelector('#countryCurrencySymbol_value');
    const currencyNameHolder = document.querySelector('#countryCurrencyName_value');
    ...
    const currencySymbol = (data.currencies[0].symbol) ? data.currencies[0].symbol : '-';
